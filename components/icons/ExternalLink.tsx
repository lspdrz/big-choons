...
const ExternalLink: React.FC<Props> = ({ color, width, height }: Props) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        d="M14 3C14 2.44772 14.4477 2 15 2H21C21.5523 2 22 2.44772 22 3V9C22 9.55228 21.5523 10 21 10C20.4477 10 20 9.55228 20 9V5.41421L9.70711 15.7071C9.31658 16.0976 8.68342 16.0976 8.29289 15.7071C7.90237 15.3166 7.90237 14.6834 8.29289 14.2929L18.5858 4H15C14.4477 4 14 3.55228 14 3Z"
        fill={color}
      />
      <path
